...
cover: cover.jpg
draft: false
images: [wifi-connect-instructions.png, balena-etcher.png, wifi-connect-step-3-1.png, wifi-connect-step-3-2.png, wifi-connect-step-3-3.png, wifi-connect-step-3-4.png, check-path.png, wifi-connect-status.png ]
---
...
<ImageWithDescription
  id="wifi-connect-instructions"
  src={props.images[0].publicURL}
  alt="Instrucciones de WiFi Connect (en inglés)"
/>
...
<ImageWithDescription
  id="wifi-connect-step-3-4"
  src={props.images[5].publicURL}
  alt="Acepta los cambios"
/>
...
<ImageWithDescription
  ...
  alt="Cómo comprobar si hace falta actualizar el PATH"
/>
...
<ImageWithDescription
  id="wifi-connect-status"
  src={props.images[7].publicURL}
  alt="Cómo comprobar que el estado del servicio de WiFi Connect funcionando correctamente"
/>
...
<ImageWithDescription
  id="wifi-connect-instructions-2"
  src={props.images[0].publicURL}
  alt="Instrucciones de WiFi Connect (en inglés)"
/>
