...
JavaScript, Node.js o cualquier cosa nueva a la que me estuviera enfrentando. En
...
<ImageWithDescription
  id="chromebook-nodeconf"
  src={props.images[0].publicURL}
  alt="Mi chromebook tratando de compilar Node.js durante la NodeCONF EU 2018"
>
  <small>
    En mi primera NodeCONF EU fui a un taller para hacer mi primera aportación
    a Node.js. El problema es que fui con un chromebook que tardó casi 2 horas en
    compilar Node.js.
  </small>
</ImageWithDescription>
