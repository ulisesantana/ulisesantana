...
cover: ./header.png
draft: false
images: [await-loop.png,promise-all.png]
---
...
![Yo vestido de Le˜ñador con hacha al hombro](./lumberjack.jpeg)
...
![GIF de los bailarines del ataúd](./coffin-dance.gif)
...
![GIF de Sheldon respirando compulsivamente en una bolsa de papel](./sheldon-bag.gif)

![GIF de Pickle Rick a punto de morir de insolación](./pickle-rick.gif)
...
![Resultado de ejecutar la demo para la comparación del async](./useless-async.png)
...
<ImageWithDescription
  ...
  alt="Las promesas se resuelven una a una"
>
  <small>
...
<ImageWithDescription
  ...
  alt="Las promesas se resuelven a la vez"
>
  <small>
...
![Resultado de ejecutar la demo para bucles asíncronos](./async-loop.png)
...
![Pasar de CommonJS to ESModules](./cjs-to-esm.png)
...
![Resultado de ejecutar la demo para comparar valores cacheados por promesa o por valor](./cached-promises.png)

En esta otra demo echo a correr estos dos trozos de código cien millones de veces para ver si realmente hay diferencia. La realidad es que la hay y es recomendable cachear la promesa en vez del valor si queremos seguir rascando performance.
...
![GIF de El Nota en el Gran Lebowski dándolo todo](./fuck-yeah-dude.gif)
